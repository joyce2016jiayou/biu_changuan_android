...
public class MonthCalenDarView extends ViewPager {
    ...
    private CalendarPagerAdapter2 calendarPagerAdapter;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int calendarHeight;
        if (getAdapter() != null) {
            MonthView2 view = (MonthView2) getChildAt(0);
            if (view != null) {
    ...
    private void refreshMonthView(int position) {
        MonthView2 monthView = calendarPagerAdapter.getViews().get(position);
     ...
     */
    public MonthCalenDarView setOnCalendarViewAdapter(int item_layout, CalendarViewAdapter calendarViewAdapter) {
     ...
     * 将指定日期的农历替换成对应文字
     */
    public MonthCalenDarView setSpecifyMap(HashMap<String, String> map) {
     ...
     * @return
     */
    public MonthCalenDarView setInitDate(String date) {
     ...
     * @return
     */
    public MonthCalenDarView setStartEndDate(String startDate, String endDate) {
     ...
     * @return
     */
    public MonthCalenDarView setMultiDate(List<String> dates) {
     ...
     * @return
     */
    public MonthCalenDarView setSingleDate(String date) {
     ...
     * @return
     */
    public MonthCalenDarView setDisableStartEndDate(String startDate, String endDate) {
