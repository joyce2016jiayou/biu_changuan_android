...
public class DateBean {
    ...
    private boolean is_future_class;//是否是将来的课程
    ...
    public boolean isIs_future_class() {
        return is_future_class;
    }

    public void setIs_future_class(boolean is_future_class) {
        this.is_future_class = is_future_class;
    }
