...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    public HourAndMinutePicker(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mHourPicker.setSelectedItemTextColor(Color.parseColor("#000000"));
        mMinutePicker.setSelectedItemTextColor(Color.parseColor("#000000"));
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        int selectedItemTextColor = a.getColor(R.styleable.HourAndMinutePicker_selectedTextColor,
                getResources().getColor(R.color.btn_text_color));
