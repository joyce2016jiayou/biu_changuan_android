...
//        mDayPicker.setBackgroundDrawable(getBackground());
		mYearPicker.setShowCurtain(false);
		mYearPicker.setShowCurtainBorder(false);
		mMonthPicker.setShowCurtain(false);
		mMonthPicker.setShowCurtainBorder(false);
		mDayPicker.setShowCurtain(false);
		mDayPicker.setShowCurtainBorder(false);
    }
