...
public class NoneBlockDrawer extends BaseBlockDrawer {
    ...
    public NoneBlockDrawer(int blockNormalColor, int blockFocusedColor,
                           int blockErrorColor, int blockShape,
                           int blockLineWidth, int blockCorner,boolean isEnteredState) {
        super(blockNormalColor, blockFocusedColor, blockErrorColor,
