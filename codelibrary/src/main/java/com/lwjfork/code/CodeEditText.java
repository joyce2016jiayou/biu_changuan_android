...
public class CodeEditText extends EditText {
    ...
    private boolean isEnteredState;//已输入是否显示颜色
    ...
    private void parseAttrs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        isEnteredState = typedArray.getBoolean(R.styleable.CodeEditText_isEnteredState, false);
        blockDrawer = createBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
     ...
     * @return
     */
    private BaseBlockDrawer createBlockDrawer(int blockNormalColor, int blockFocusColor, int blockErrorColor, @BlockShape int blockShape, int blockLineWidth, int blockCorner,boolean isEnteredState) {
        switch (blockShape) {
            case BlockShape.SOLID:
                return new SolidBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
            case BlockShape.STROKE:
                return new StrokeBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
            case BlockShape.UNDERLINE:
                return new UnderlineBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
            default:
                return new NoneBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
        }
    }
...
//        super.onDraw(canvas);
    ...
    public void setBlockShape(@BlockShape int blockShape) {
        ...
        BaseBlockDrawer newBlockDrawer = createBlockDrawer(blockNormalColor, blockFocusColor, blockErrorColor, blockShape, blockLineWidth, blockCorner,isEnteredState);
