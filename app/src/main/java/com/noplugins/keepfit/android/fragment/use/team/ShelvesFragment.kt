...
class ShelvesFragment : BaseFragment()  {
    companion object {
        fun newInstance(title: String): ShelvesFragment {
...
//                    startActivity(toInfo)
    ...
    private fun requestData(){
        ...
        params["type"] = 1
        val subscription = Network.getInstance("课程管理上架", activity)
            .courseManagerByArea(params,
                ProgressSubscriber("课程管理上架", object : SubscriberOnNextListener<Bean<ManagerBean>> {
