...
public class MonthWhatchFragment extends ViewPagerFragment {
    private View view;
    public static MonthWhatchFragment newInstance(String title) {
        MonthWhatchFragment fragment = new MonthWhatchFragment();
