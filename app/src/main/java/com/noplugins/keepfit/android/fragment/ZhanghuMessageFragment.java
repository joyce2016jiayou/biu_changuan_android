...
public class ZhanghuMessageFragment extends Fragment {
    ...
    public static ZhanghuMessageFragment newInstance(String title) {
        ZhanghuMessageFragment fragment = new ZhanghuMessageFragment();
    ...
    private void set_list_resource(final List<String> dates) {
        ...
        zhanghuMessageAdapter = new ZhanghuMessageAdapter(dates, getActivity());
