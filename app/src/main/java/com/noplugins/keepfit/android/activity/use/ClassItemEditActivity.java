...
public class ClassItemEditActivity extends BaseActivity implements CCRSortableNinePhotoLayout.Delegate {
    ...
    public void initView() {
        ...
        input_class_detail_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ClassItemEditActivity.this, EditClassDetaiActivity.class);
    ...
    private void set_icon_image() {
        logo_image.setOnClickListener(new View.OnClickListener() {//添加图片
            @Override
            public void onClick(View view) {
                EasyPhotos.createAlbum(ClassItemEditActivity.this, true, GlideEngine.getInstance())
        ...
        add_class_teacher_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (startHour > endHour) {
                    Toast.makeText(ClassItemEditActivity.this,
...
//        });
    ...
    private void back_pop() {
        PopWindowHelper.public_tishi_pop(ClassItemEditActivity.this, "提示", "是否退出团课创建？", "取消", "确定", new DialogCallBack() {
            @Override
            public void save() {
                finish();
            }
                ...
                .add_class(params,
                        new ProgressSubscriber<>("添加课程", new SubscriberOnNextListener<Bean<AddClassEntity>>() {
                            ...
                            public void onNext(Bean<AddClassEntity> result) {
                                Intent intent = new Intent(ClassItemEditActivity.this, YaoQingTeacherActivity.class);
                            ...
                            @Override
                            public void onError(String error) {
                                Toast.makeText(ClassItemEditActivity.this, error, Toast.LENGTH_SHORT).show();
                            }
                        }, this, true));
    }
