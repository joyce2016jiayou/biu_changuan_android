...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    private List<TeacherBean> submit_tescher_list;

    public RecyclerViewAdapter(List<TeacherBean> m_submit_tescher_list, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        TeacherBean teacherBean = submit_tescher_list.get(position);
