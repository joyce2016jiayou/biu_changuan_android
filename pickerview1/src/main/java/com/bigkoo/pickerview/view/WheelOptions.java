...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions2Items == null) {//只有1级联动数据
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem());
                    }
                } else {
                    if (!isRestoreItem) {
                    ...
                    if (mOptions3Items != null) {
                        ...
                        if (optionsSelectChangeListener != null) {
                            optionsSelectChangeListener.onOptionsSelectChanged2(opt2Select);
                        }
                    }
                }
            }
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    if (!isRestoreItem) {
                        ...
                        opt3 = wv_option3.getCurrentItem() >= mOptions3Items.size() - 1 ?
                                mOptions3Items.size() - 1 : wv_option3.getCurrentItem();
                    }
                    ...
                    //3级联动数据实时回调
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged3(opt3);
                    }
                } else {//只有2级联动数据，滑动第2项回调
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged3(0);
                    }
                }
            }
        };
        ...
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
                    optionsSelectChangeListener.onOptionsSelectChanged3(wv_option1.getCurrentItem(), wv_option2.getCurrentItem(), index);
                }
            });
        }
    }
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        wv_option1.setCurrentItem(wv_option1.getCurrentItem());// 初始化时显示的数据
        // 选项2
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
                    optionsSelectChangeListener.onOptionsSelectChanged(index);
                }
            });
        }
        ...
        if (options2Items == null) {
            ...
            if (optionsSelectChangeListener != null) {
                wv_option2.setOnItemSelectedListener(new OnItemSelectedListener() {
                    @Override
                    public void onItemSelected(int index) {
                        optionsSelectChangeListener.onOptionsSelectChanged2(index);
                    }
                });
            }
        }
        if (options3Items == null) {
            ...
            if (optionsSelectChangeListener != null) {
                wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() {
                    @Override
                    public void onItemSelected(int index) {
                        optionsSelectChangeListener.onOptionsSelectChanged3(index);
                    }
                });
            }
        }
